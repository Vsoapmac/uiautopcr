...
class TestSearch(ClientBasic):
    ...
    def mana_page(self):
        ...
        try:
            ...
            is_in_page = True
            logging.info("检测到已经在mana关卡，无需进入")
        except:
            pass
        if not is_in_page:
            try:

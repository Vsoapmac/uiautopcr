...
class TestShop(ClientBasic):
    ...
    def shop_page(self):
        ...
        try:
            ...
            logging.info("检测到已进入页面，无需再次进入页面")
        except:
            Page.shop_page()
            logging.info("进入商店页面完毕")
...
class TestMission(ClientBasic):
    ...
    def test_collect_mission(self, mission_page):
        ...
        wait(Template(self.shot_path + self.__page_dict["common_mission"], record_pos=(0.066, -0.255), resolution=(1280, 720), threshold=0.9), timeout=2) # 普通
        ...
        wait(Template(self.shot_path + self.__page_dict["daily_mission"], record_pos=(-0.102, -0.256), resolution=(1280, 720), threshold=0.9), timeout=2) # 每日
        ...
        wait(Template(self.shot_path + self.__page_dict["name_mission"], record_pos=(0.235, -0.256), resolution=(1280, 720), threshold=0.9), timeout=2) # 称号

...
class TestArana(ClientBasic):
    ...
    def test_arana(self, arana_page):
        ...
        try:
            ...
            logging.info("检测到防守成功，取消页面")
            CommonButton.cancel()
        except:
            pass
        # 收取竞技场金币
        logging.info("收取竞技场金币")
        ...
        try:
            ...
            sleep(2)
            logging.info("收取竞技场金币完成")
        except:
            logging.info("没有竞技场金币")
        logging.info("点击竞技场第一个人")
    ...
    def test_princess_arana(self, princess_arana_page):
        ...
        try:
            ...
            sleep(2)
            logging.info("收取公主竞技场金币完成")
        except:
            logging.info("没有公主竞技场金币")
        logging.info("点击公主竞技场第一个人")
        touch([0.612*self.w,0.302*self.h]) # 点击第一个人
        sleep(2)
        # TODO:增加全部次数用完之后，无法继续进行的逻辑
        in_coding = False
        ...
        if not in_coding:
            ...
            logging.info("公主竞技场正在冷却中，返回")
            CommonButton.cancel()

    @pytest.fixture
    def arana_page(self):
        """竞技场"""
        logging.info("开始进入竞技场页面")
        try:
            ...
            logging.info("检测到已经在公主竞技场页面，无需进入")
        except:
            Page.arana_page()
            logging.info("进入竞技场完毕")

    @pytest.fixture
    def princess_arana_page(self):
        """公主竞技场"""
        logging.info("开始进入公主竞技场页面")
        try:
